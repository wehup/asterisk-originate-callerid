...
/*
 * May 2011 - Modified to detect for voicemail.
 * Original app_meetme.c - meetme
 * Christopher Mendes <cmendes0101@gmail.com> 
 * Christopher Mendes <cmendes0101@gmail.com> 
 */
 ...
 * \author (Modifier) Christopher Mendes <cmendes0101@gmail.com>
 * \author (Modifier) Guilherme Roberge Daleffe <falecomdaleffe@gmail.com>
 *
	...
	<application name="Originate" language="en_US">
		...
		<syntax>
			<parameter name="tech_data" required="true">
				<para>Channel technology and data for creating the outbound channel. For example, SIP/1234.</para>
			</parameter>
			...
			<parameter name="arg4" required="false">
				<para>This is the <literal>CallerID Number</literal> for the outgoing call.</para>
			</parameter>
			<parameter name="arg5" required="false">
				<para>This is the <literal>CallerID Name</literal> for the outgoing call.</para>
			</parameter>
...
static int originate_exec(struct ast_channel *chan, const char *data)
{
	...
	if (!strcasecmp(args.type, "exten")) {
		...
		ast_pbx_outgoing_exten(chantech, cap_slin, chandata,
				timeout * 1000, args.arg1, exten, priority, &outgoing_status, 0, args.arg4,
				args.arg5, NULL, NULL, NULL, 0);
	} else if (!strcasecmp(args.type, "app")) {
		ast_debug(1, "Originating call to '%s/%s' and connecting them to %s(%s)\n",
				chantech, chandata, args.arg1, S_OR(args.arg2, ""));

		ast_pbx_outgoing_app(chantech, cap_slin, chandata,
				timeout * 1000, args.arg1, args.arg2, &outgoing_status, 0, args.arg4,
				args.arg5, NULL, NULL, NULL);
	} else {
